...
/**
 *  @brief This function prepares command resp of MFG GENERIC CMD
 *
 *  @param pmpriv       A pointer to mlan_private structure
 *  @param resp         A pointer to HostCmd_DS_COMMAND
 *  @param pioctl_buf   A pointer to mlan_ioctl_req structure
 ...
 *  @return             MLAN_STATUS_SUCCESS
 */
static mlan_status wlan_ret_mfg_generic_cmd(pmlan_private pmpriv,
					    HostCmd_DS_COMMAND *resp,
					    mlan_ioctl_req *pioctl_buf)
{
	mlan_ds_misc_cfg *misc = MNULL;
	mfg_Cmd_InternalTest_t *mcmd =
		(mfg_Cmd_InternalTest_t *)&resp->params.mfg_InternalTest_t;
	mfg_Cmd_InternalTest_t *cfg = MNULL;
	...
	misc = (mlan_ds_misc_cfg *)pioctl_buf->pbuf;
	cfg = (mfg_Cmd_InternalTest_t *)&misc->param.mfg_InternalTest_t;
	cfg->error = wlan_le32_to_cpu(mcmd->error);
