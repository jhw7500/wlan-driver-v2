...
/** TLV : enable/disable blocking frames */
#define NXP_BLOCK_FRAME_TLV_ID (PROPRIETARY_TLV_BASE_ID + 362) /* 0x026a */

/** TLV buffer : block frame */
typedef PACK_START struct _tlvbuf_block_frame {
	/** Header */
	TLVHEADER;
	/** block frame bitmask */
	t_u32 flag;
} PACK_END tlvbuf_block_frame;
...
/** sys_cfg_wacp_mode structure */
typedef struct _wacp_mode_t {
	/** Action */
	int subcmd;
	/** Action */
	int action;
	/** wacp_mode TLV */
	tlvbuf_wacp_mode wacp_mode_tlv;
} wacp_mode_t;
