...
REQUEST_RELOAD_BLOCK="$(extract_c_function '^static int woal_request_fw_reload_internal' "$MAIN_C")"
...
DRV_MODE_BLOCK="$(extract_c_function '^static mlan_status woal_switch_drv_mode_internal' "$MAIN_C")"
